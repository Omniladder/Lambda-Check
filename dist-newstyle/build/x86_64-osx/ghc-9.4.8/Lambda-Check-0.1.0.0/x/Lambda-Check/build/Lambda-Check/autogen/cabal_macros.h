...
/* package Lambda-Check-0.1.0.0 */
#ifndef VERSION_Lambda_Check
#define VERSION_Lambda_Check "0.1.0.0"
#endif /* VERSION_Lambda_Check */
#ifndef MIN_VERSION_Lambda_Check
#define MIN_VERSION_Lambda_Check(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Lambda_Check */
...
#define CURRENT_COMPONENT_ID "Lambda-Check-0.1.0.0-inplace-Lambda-Check"
